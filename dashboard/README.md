...
4. Structural prediction using Chimera can be performed on the final selection

<img height="300" alt="image" src="https://github.com/user-attachments/assets/d1196c79-3540-49ea-9c6d-0187e3cf85d6" />

5. Finally all the data can be downloaded in a PDF file
